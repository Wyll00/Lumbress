export const translations = {
    es: {
        ...
        community: "Comunidad",
        messages: "Mensajes",
        workshop: "Taller de novela",
        subscriptionsNav: "Suscripciones",
        settingsNav: "Ajustes",
        appVersion: "Lumbres v0.12.0",
        ...
        // Auth (login / registro)
        authWelcome: "Qué bien verte",
        authLoginSub: "Tu biblioteca sigue justo donde la dejaste.",
        ...
        authRegisterLink: "Crear cuenta",
        authCreateAccount: "Empieza tu biblioteca",
        authRegisterSub: "Un rincón para todo lo que lees.",
        authUsername: "Nombre de Usuario",
        authConfirmPassword: "Confirmar Contraseña",
        authRegisterBtn: "Registrarse",
        authRegistering: "Registrando...",
        ...
        authForgotLink: "No la recuerdo",
        forgotTitle: "Te ayudamos a volver",
        forgotSub: "Te enviaremos un código de 6 dígitos a tu correo",
        forgotResetSub: "Introduce el código que te enviamos y tu nueva contraseña",
        forgotEmailLabel: "Correo Electrónico",
        forgotSendBtn: "Enviar código",
        forgotSending: "Enviando...",
        forgotSent: "Si la cuenta existe, te hemos enviado un código ✓",
        forgotCodeLabel: "Código de recuperación",
        forgotNewPassword: "Nueva contraseña (mín. 8 caracteres)",
        forgotResetBtn: "Cambiar contraseña",
        forgotResetting: "Guardando...",
        forgotResend: "Volver a pedir el código",
        forgotDoneTitle: "¡Contraseña actualizada!",
        forgotDoneSub: "Ya puedes iniciar sesión con tu nueva contraseña",
        forgotBackToLogin: "Volver a inicio de sesión",
        forgotError: "No se pudo completar la operación.",
    },
    en: {
        // Sidebar
        dashboard: "Home",
        ...
        // Auth (login / register)
        authWelcome: "Good to see you",
        authLoginSub: "Your library is right where you left it.",
        ...
        authCreateAccount: "Start your library",
        authRegisterSub: "A corner for everything you read.",
        ...
        authForgotLink: "I forgot it",
        forgotTitle: "Let's get you back in",
        forgotSub: "We'll send a 6-digit code to your email",
        forgotResetSub: "Enter the code we sent you and your new password",
        forgotEmailLabel: "Email",
        forgotSendBtn: "Send code",
        forgotSending: "Sending...",
        forgotSent: "If the account exists, we've sent you a code ✓",
        forgotCodeLabel: "Reset code",
        forgotNewPassword: "New password (min. 8 characters)",
        forgotResetBtn: "Change password",
        forgotResetting: "Saving...",
        forgotResend: "Request the code again",
        forgotDoneTitle: "Password updated!",
        forgotDoneSub: "You can now sign in with your new password",
        forgotBackToLogin: "Back to sign in",
        forgotError: "The operation could not be completed.",
    }
};
